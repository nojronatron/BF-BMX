...
namespace BFBMX.Service.Helpers
{
    public class FileProcessor : IFileProcessor
    {
        ...
        private readonly string SloppyBibPattern = @"\b\S{1,26}(?:\s*[,|\t]\s*\S{1,26}){4}\b"; // match 5 groups of non-space characters with length of 1-26, separated by commas or tabs padded with 0 or more spaces
